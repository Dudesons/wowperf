...
went, what each death cost, which interrupts were missed and which defensives were pressed far
below what their cooldown allowed, compares all of it against fast completions of the same
dungeon, and writes one self-contained HTML file you open from disk.
