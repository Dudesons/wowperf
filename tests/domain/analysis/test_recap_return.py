...
from tests.domain.analysis.test_recap_timeline import a_cast
...
def test_a_teammates_resurrection_before_the_first_action_wins() -> None:
    back = return_of((raised(68_000),), (), dead(back_after=12.0), REINCARNATION)
...
def test_a_resurrection_event_by_the_player_themselves_is_a_self_resurrection() -> None:
    back = return_of((raised(65_000, caster_id=1),), (), dead(back_after=9.0),
                     SelfResurrections())
...
def test_a_listed_spell_cast_by_the_dead_player_is_a_self_resurrection() -> None:
    ...
    back = return_of((), (cast,), dead(back_after=15.0), REINCARNATION)
